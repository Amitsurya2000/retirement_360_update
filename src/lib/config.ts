...
export function whatsappLink(prefilledMessage?: string): string {
  const text = prefilledMessage ?? "Hello! I'm using the RetireWell app and would like to speak with a Retirement Specialist about my plan. I'm looking for someone who doesn't sell products — just gives me a clear plan.";
